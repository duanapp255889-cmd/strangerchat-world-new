...
export default function Home() {
  ...
  if (!isChatOpen) return <ClosedScreen c={c} lang={lang} setLang={setLang} now={now} reminderOpen={reminderOpen} setReminderOpen={setReminderOpen} reminderChannel={reminderChannel} setReminderChannel={setReminderChannel} reminderEmail={reminderEmail} setReminderEmail={setReminderEmail} reminderMessage={reminderMessage} setReminderMessage={setReminderMessage} legalPage={legalPage} setLegalPage={setLegalPage} />;
